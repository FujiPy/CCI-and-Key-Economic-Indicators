...
# Fetch the raw notebook JSON
notebook_dict = _message.blocking_request('get_ipynb')['ipynb']

# Convert to a NotebookNode object (nbformat v4)
notebook_node = nbformat.from_dict(notebook_dict)

# Save as .ipynb file in the current Colab VM
with open("CCIMarkdown.ipynb", "w") as f:
...
```python
!jupyter nbconvert --to markdown "/content/CCIMarkdown.ipynb"

```

    [NbConvertApp] WARNING | pattern '/content/CCIMarkdown.ipynb' matched no files
...
```
    ...
    <ipython-input-36-c91e3258b95d> in <cell line: 0>()
          1 from google.colab import files
    ----> 2 files.download("CCIMarkdown.md")
    ...
    FileNotFoundError: Cannot find file: CCIMarkdown.md


**Instructions to begin:**
* Download the dataset as a csv file to your local content path in the colab notebook
* You can rename the file however you like while maintaining the '.csv' ending. I have named it 'US_MACRO_DATA.csv' in this notebook.
* Call the csv file using the pd.read_csv command
...
```
  ...
  <div id="df-0995569c-10e3-4578-a491-fcad78ca7194" class="colab-df-container">
    <div>
<style scoped>
...
<p>241 rows × 12 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-0995569c-10e3-4578-a491-fcad78ca7194')"
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-0995569c-10e3-4578-a491-fcad78ca7194 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-0995569c-10e3-4578-a491-fcad78ca7194');
        const dataTable =
    ...
    <div id="df-b2c9a8a9-9606-46c8-af0f-1343e9807f21">
      <button class="colab-df-quickchart" onclick="quickchart('df-b2c9a8a9-9606-46c8-af0f-1343e9807f21')"
...
<style>
      ...
      <script>
        ...
        (() => {
          let quickchartButtonEl =
            document.querySelector('#df-b2c9a8a9-9606-46c8-af0f-1343e9807f21 button');
  ...
  <div id="id_5cb78289-f201-4498-bc5a-5facafa4cb61">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_5cb78289-f201-4498-bc5a-5facafa4cb61 button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
